...
void SetupServerArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-coinbaselocktime", strprintf("Set nLockTime to the current block height (default: %d, this is different from BIP34 and not mandatory)", DEFAULT_COINBASE_LOCKTIME), ArgsManager::ALLOW_ANY, OptionsCategory::BLOCK_CREATION);
