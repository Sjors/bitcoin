...
UniValue coinbaseTxToJSON(const CTransaction& coinbase_tx)
{
    ...
    coinbase_tx_obj.pushKV("locktime", (int64_t)coinbase_tx.nLockTime);
    coinbase_tx_obj.pushKV("sequence", (int64_t)vin_0.nSequence);
    coinbase_tx_obj.pushKV("is_final", vin_0.nSequence == CTxIn::SEQUENCE_FINAL);
    coinbase_tx_obj.pushKV("script_sig", HexStr(vin_0.scriptSig));
        ...
        "If verbosity is 0, returns a string that is serialized, hex-encoded data for block 'hash'.\n"
                ...
                RPCResult::Type::OBJ, "", "",
                {
                    ...
                    {RPCResult::Type::OBJ, "coinbase_tx", "Coinbase transaction metadata",
                    {
                        ...
                        {RPCResult::Type::BOOL, "is_final", "Whether the coinbase input's nSequence equals 0xffffffff (SEQUENCE_FINAL)"},
                        {RPCResult::Type::STR_HEX, "script_sig", "The coinbase input's scriptSig"},
