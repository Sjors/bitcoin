...
public:
    ...
    InteractResult Interact()
    {
        ...
        while (true) {
            ...
            const auto& [recv_bytes, _more] = m_transport->GetBytesToSendSv2(!m_msg_to_send.empty());
    ...
    void SendPacket(Sv2NetMsg msg)
    {
        ...
        const size_t encrypted_payload_size = Sv2Cipher::EncryptedMessageSize(msg.m_msg.size());
