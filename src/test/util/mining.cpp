                                     ...
                                     const node::BlockCreateOptions& assembler_options)
{
    ...
    auto block_template = block_template_manager.CreateNewTemplate(node::MergeMiningOptions(assembler_options, block_template_manager.GetInitBlockCreateOptions()));
