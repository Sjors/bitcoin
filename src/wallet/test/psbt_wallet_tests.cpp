...
BOOST_AUTO_TEST_CASE(psbt_updater_test)
{
    ...
    bool complete = true;
    BOOST_REQUIRE(!m_wallet.FillPSBT(psbtx, complete, std::nullopt, false, true, /*avoid_script_path=*/false));
    ...
    BOOST_CHECK(m_wallet.FillPSBT(psbtx, complete, std::nullopt, true, true, /*avoid_script_path=*/false));
}
