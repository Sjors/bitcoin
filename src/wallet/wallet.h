...
inline constexpr uint64_t KNOWN_WALLET_FLAGS =
    ...
    |   WALLET_FLAG_MULTIPATH_DESCRIPTORS;
...
inline const std::map<WalletFlags, std::string> WALLET_FLAG_TO_STRING{
    ...
    {WALLET_FLAG_MULTIPATH_DESCRIPTORS, "multipath_descriptors"}
};
...
inline const std::map<std::string, WalletFlags> STRING_TO_WALLET_FLAG{
    ...
    {WALLET_FLAG_TO_STRING.at(WALLET_FLAG_MULTIPATH_DESCRIPTORS), WALLET_FLAG_MULTIPATH_DESCRIPTORS}
};
