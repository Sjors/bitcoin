...
static RPCMethod createwallet()
{
    return RPCMethod{
        ...
        "Creates and loads a new wallet.\n",
        {
            ...
            {"multipath", RPCArg::Type::BOOL, RPCArg::Default{false}, "Store descriptors in multipath form. The wallet keeps one BIP 389 multipath descriptor per output type, covering both the receive and change chain, and only supports such descriptors. Combined with external_signer, the signer must support the getdescriptors --multipath argument."},
        },
        RPCResult{
            RPCResult::Type::OBJ, "", "",
            {
