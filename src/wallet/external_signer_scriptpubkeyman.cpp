...
util::Result<void> ExternalSignerScriptPubKeyMan::DisplayAddressRegistered(const CTxDestination& dest,
                                                                           const ExternalSigner& signer,
                                                                           const std::string& registration,
                                                                           bool change,
                                                                           uint32_t index) const
{
    const UniValue& result{signer.DisplayAddressRegistered(registration, change, index)};
