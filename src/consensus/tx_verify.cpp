...
bool EvaluateSequenceLocks(int block_height, int64_t block_time, std::pair<int, int64_t> lockPair)
{
    if (lockPair.first >= block_height || lockPair.second >= block_time) return false;
