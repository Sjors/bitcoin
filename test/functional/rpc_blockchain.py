...
class BlockchainTest(BitcoinTestFramework):
    ...
    def _test_getblock(self):
        ...
        def assert_coinbase_metadata(hash, verbosity):
            ...
            expected_keys = {"version", "locktime", "sequence", "is_final", "script_sig"}
            ...
            assert_equal(block["coinbase_tx"]["is_final"], coinbase_tx["vin"][0]["sequence"] == SEQUENCE_FINAL)
            assert_equal(block["coinbase_tx"]["script_sig"], coinbase_tx["vin"][0]["coinbase"])
