...
class GetsilentpaymentblockdataTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(txid, '2c09a66f51a40888e1a3ab287d96fef5da1f6d7914b570d80e88631c8b823dd2')
        ...
        self.generate(node, 1)
        silent_data = node.getsilentpaymentblockdata(node.getbestblockhash())
        assert_equal(silent_data['bip352_tweaks'], ['0292d9514e20f2eb852e904b122c3fbcb20004dceb129f1013feab3b44240202da'])
