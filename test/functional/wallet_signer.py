...
class WalletSignerTest(BitcoinTestFramework):
    ...
    def test_bip388_policy(self):
        ...
        self.nodes[1].createwallet(wallet_name='hww_policy', disable_private_keys=True, external_signer=True, blank=True)
        ...
        # after importdescriptors is the multisig policy under test.
