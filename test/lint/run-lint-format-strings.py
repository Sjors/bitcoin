...
FALSE_POSITIVES = [
    ...
    ("src/validationinterface.cpp", "LogPrintLevel(category, level, fmt \"\\n\", __VA_ARGS__)"),
    ("src/validationinterface.cpp", "LogPrintLevel(category, BCLog::Level::Trace, \"Enqueuing \" fmt \"\\n\", __VA_ARGS__)"),
    ("src/validationinterface.cpp", "LogPrintLevel(BCLog::VALIDATION, BCLog::Level::Debug, \"block hash=%s state=%s\\n\", __func__, block.GetHash().ToString(), state.ToString())"),
    ("src/validationinterface.cpp", "LogPrintLevel(BCLog::VALIDATION, BCLog::Level::Debug, \"block hash=%s\\n\", __func__, block->GetHash().ToString())"),
