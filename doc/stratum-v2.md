...
at this point. The Job Declarator client uses this to annouce upstream that
...
An alternative to implementating the Noise Protcol in Bitcoin Core is to use a
unix socket instead and rely on the user to install a seperate tool to convert
to this protcool. Such a tool could be provided by developers of the Job
Declarator client.
...
Requires [#29032](https://github.com/bitcoin/bitcoin/pull/29032).
