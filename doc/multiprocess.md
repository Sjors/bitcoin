...
When cross-compiling and not using depends, a native `mpgen` tool from [libmultiprocess](https://github.com/chaincodelabs/libmultiprocess) is required. It can be set manually by passing `-DMPGEN_EXECUTABLE=/path/to/mpgen`
