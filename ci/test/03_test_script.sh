...
BITCOIN_CONFIG_ALL="$BITCOIN_CONFIG_ALL -DWITH_MULTIPROCESS=ON -DWITH_SV2=ON -DENABLE_WALLET=OFF -DENABLE_EXTERNAL_SIGNER=OFF -DCMAKE_INSTALL_PREFIX=$BASE_OUTDIR"
